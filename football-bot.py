...
print(f"🏆 Текущий сезон: {get_current_season()}")
print(f"📅 Сегодня: {datetime.now().strftime('%d.%m.%Y')}")
print(f"🔑 Ключ API загружен")
...
✅ Бот @footballlyres_bot готов к работе!
    """
...
if __name__ == "__main__":
    print("⚽ Бот запущен!")
    print(f"🤖 Имя бота: @footballlyres_bot")
    print(f"🔑 Токен: {TELEGRAM_TOKEN[:10]}...")
    print(f"🔑 API ключ: {RAPIDAPI_KEY[:10]}...")
    print("📡 Тестирую подключение к API...")
